...
extern void GF2X_EXPORTED gf2x_fake_fft_info_init_mp(
        gf2x_fake_fft_info_ptr p,
        size_t bits_a,
        size_t bits_b,
        ...); 
...
struct gf2x_fake_fft_info {
    ...
    inline static gf2x_fake_fft_info mul_info(size_t nF, size_t nG) {
        ...
        gf2x_fake_fft_info_init(&a, nF, nG);
        return a;
    }
    inline static gf2x_fake_fft_info mp_info(size_t nF, size_t nG) {
        gf2x_fake_fft_info a;
        gf2x_fake_fft_info_init_mp(&a, nF, nG);
        return a;
    }
    ...
    {
        gf2x_fake_fft_addcompose(this, y, x1, x2, temp2, temp1);
    }
    inline void addcompose_n(ptr y, srcptr * x1, srcptr * x2, size_t n, ptr temp2, ptr temp1) const
    {
        gf2x_fake_fft_addcompose_n(this, y, x1, x2, n, temp2, temp1);
    }
