...
#define DO_comp1(E)  E ## _addcompose(E, E ## _th, E ## _tf1, E ## _tg1, E ## _temp2, E ## _temp1)
#define DO_comp2(E)  E ## _addcompose(E, E ## _th, E ## _tf2, E ## _tg2, E ## _temp2, E ## _temp1)
#define DO_compx(E)  E ## _addcompose_n(E, E ## _thx, (E ## _srcptr *) E ## _tfs, (E ## _srcptr *) E ## _tgs, 2, E ## _temp2, E ## _temp1)
